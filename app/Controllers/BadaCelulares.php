...
class BadaCelulares extends BaseController
{
	public function celulares_management()
	{
	    $crud = new GroceryCrud();

        $crud->setLanguage('Spanish');
        $crud->setSubject('Celular','Celulares');
        // $crud->columns(['cuit','celular_bada','mail'])
        //     ->displayAs('cuit', 'CUIT')
        //     ->displayAs('celular_bada','CELULAR')
        //     ->displayAs('mail','EMAIL')
        //     ->fields(['cuit','celular_bada']);

	    $crud->setTable('bada_celulares');
